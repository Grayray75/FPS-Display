...
public class YaclOptionScreen {
    public static Screen generateScreen(Screen parent) {
        ...
        categoryBuilder.name(Component.translatable("text.fpsdisplay.options.title"));

        final ConfigData configDefaults = new ConfigData();
        ConfigData config = ConfigManager.getConfig();

        categoryBuilder.option(Option.<Boolean>createBuilder()
            .name(Component.translatable("text.fpsdisplay.options.enabled"))
        ...
        categoryBuilder.option(Option.<Boolean>createBuilder()
            .name(Component.translatable("text.fpsdisplay.options.advancedStats"))
        ...
        categoryBuilder.option(Option.<Float>createBuilder()
            .name(Component.translatable("text.fpsdisplay.options.textSize"))
        ...
        categoryBuilder.option(Option.<Color>createBuilder()
            .name(Component.translatable("text.fpsdisplay.options.textColor"))
        ...
        categoryBuilder.option(Option.<Integer>createBuilder()
            .name(Component.translatable("text.fpsdisplay.options.textAlpha"))
        ...
        categoryBuilder.option(Option.<Boolean>createBuilder()
            .name(Component.translatable("text.fpsdisplay.options.textShadows"))
        ...
        categoryBuilder.option(Option.<Integer>createBuilder()
            .name(Component.translatable("text.fpsdisplay.options.offsetTop"))
            .binding(configDefaults.offsetTop, () -> config.offsetTop, newValue -> config.offsetTop = newValue)
            .controller(IntegerFieldControllerBuilder::create)
            .build()
        );
        categoryBuilder.option(Option.<Integer>createBuilder()
            .name(Component.translatable("text.fpsdisplay.options.offsetLeft"))
        ...
        categoryBuilder.option(Option.<ConfigData.KeyMode>createBuilder()
            .name(Component.translatable("text.fpsdisplay.options.keybindMode"))
        ...
        builder.title(Component.translatable("text.fpsdisplay.options.title"));
